...
const menuLinks = [
  { label: "Fluxo", href: "/", icon: FiHome },
  { label: "Quadros", href: "/sistema/paginas/curriculos", icon: FiFolder },
  { label: "Cadastro", href: "/sistema/paginas/curriculos/novo", icon: FiPlusSquare },
];
